      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => (
            <div
              key={index}
              className={`text-center p-6 bg-surface-elevated border border-border rounded-xl hover-scale animate-fade-in-up stagger-${index + 2}`}
            >
        ...
        <div className="mb-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {featuredProjects.map((project, index) => (
              <div
                key={index}
                className={`group bg-surface-elevated border border-border rounded-xl overflow-hidden transition-all duration-300 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/10 h-full flex flex-col hover-lift animate-fade-in-up stagger-${index + 6}`}
              >
                {/* Project Image */}
