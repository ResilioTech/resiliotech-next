...
const cloudWatchProProduct = microSaasProducts.find(p => p.name === 'SignalWatch')!;

export const metadata: Metadata = {
  title: 'SignalWatch - AI-Powered Infrastructure Monitoring | Resiliotech',
  description: 'Intelligent monitoring with early warning system for infrastructure issues. Get insights into your infrastructure health with automated alerts and resolution suggestions.',
  keywords: ['monitoring', 'infrastructure', 'ai', 'predictive analytics', 'devops', 'observability', 'alerts'],
  openGraph: {
    title: 'SignalWatch - AI-Powered Infrastructure Monitoring',
    description: 'Intelligent monitoring with early warning system for infrastructure issues and AI-powered insights.',
