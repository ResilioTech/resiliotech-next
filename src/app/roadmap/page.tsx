...
export const metadata: Metadata = {
  ...
  description: 'Explore Resilio Tech\'s product roadmap — AI infrastructure tools, MLOps automation, and reliability solutions we\'re building for production AI systems.',
  alternates: {
